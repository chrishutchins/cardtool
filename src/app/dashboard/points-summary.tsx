  ...
  return (
    <div className="rounded-xl border border-zinc-700/30 bg-zinc-900/50 p-5">
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-sm text-zinc-400 mb-1">Points & Miles</h3>
      ...
      {hasPoints ? (
        ...
        <p className="text-sm text-zinc-500">
          Track your points balances in the{" "}
          <Link href="/points" className="text-blue-400 hover:text-blue-300">Points</Link> page.
        </p>
      )}
    </div>
  );
