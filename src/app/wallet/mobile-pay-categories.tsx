...
export function MobilePayCategories({
  categories,
  selectedCategoryIds,
  onToggleCategory,
  ...
  // Common categories that make sense for mobile pay
  const suggestedCategories = ["dining", "grocery", "gas", "wholesale"];
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-zinc-400">
        Select categories where you typically use mobile payments (Apple Pay, Google Pay, etc.). 
        Cards with mobile pay bonuses will earn their elevated rate on these categories.
      </p>
